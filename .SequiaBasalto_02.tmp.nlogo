...
; set grass-height ((item current-season kmax / (1 + ((((item current-season kmax * set-climacoef + initial-grass-height) - (grass-height)) / (grass-height)) * (e ^ (- r * simulation-time))))) * set-climacoef + initial-grass-height)
